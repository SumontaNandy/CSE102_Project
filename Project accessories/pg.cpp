...
int position,Save_Game=0,Save_Game_level_setup=0;
...
void play_saved_game()
{
    ...
    fscanf(playgame,"%d",&dx);
    fscanf(playgame,"%d",&dy);
    for(int i=0; i<624; i++)
...
void level_setup()
{
    if(level == 1)
    {
        if(Save_Game_level_setup==0) level1();
        l_s = 1;
        level = 0;
    }
    else if(level == 2)
    {
        if(Save_Game_level_setup==0) level2();
        l_s = 2;
        level = 0;
    }
    else if(level == 3)
    {
        if(Save_Game_level_setup==0) level3();
        l_s = 3;
        level = 0;
    }
    else if(level == 4)
    {
        if(Save_Game_level_setup==0) level4();
        l_s = 4;
        level = 0;
    }
    else if(level == 5)
    {
        if(Save_Game_level_setup==0) level5();
        l_s = 5;
        level = 0;
    }
    r_level = l_s;
